...
invalid or expired calibration, zero-reference/bulk degeneracy beyond the
...
\begin{enumerate}[leftmargin=2em]
  ...
  signed-offset injected pilot, a zero-denominator case, and a nonzero-prefilled
  mask-word case.  Require equality with the independent reference and the
  staged kernel path.
